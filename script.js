...
const ratingBelow = document.getElementById("SmallerthenFour");
...
function generateRecipeCard(recipes) {
  recipes.forEach((recipe) => {
    ...
    if(recipe.isLiked){
        recipeLike.src = "./assets/Likedheart.png";
    }
    else{
        recipeLike.src = "./assets/UnLikedheart.png";
    }
...
const menuCloseBtn = document.getElementById("MobileDrawerClose");
